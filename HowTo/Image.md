...
**Category** – Select an image priority based on the specimen type and what is shown in the image. This selection determines how early the image will be presented in the image carousel on the Specimen and/or OTU page. Images display in the following category order: holotype/exemplar, other type specimen, shows key feature, no priority. Select “holotype/exemplar” or “other type specimen” for images that show the entire specimen (or, in the case of material like cuticle, a representative section), as these will be the first viewed in the carousel. Use “shows key feature” for zoomed-in images of type material or for images of non-type specimens that preserve features that may not be well-exhibited by the type specimens.
