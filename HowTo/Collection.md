...
**Size classes** – PBDB requires that Collections include which size classes of fossils have been recovered. Your options are > 10 mm, 1-10 mm, or < 1 mm, and multiple options can be selected. If the size range of specimens is not clearly indicated in a publication, use a liberal estimate to select all possible size categories.
