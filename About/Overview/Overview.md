...
## The Future of PBot
PBot version 1.0 is now completed, as our NSF EarthCube Award ended in August, 2025. We will continue to maintain PBot and fix bugs- please report any bugs by [emailing us](mailto:PBotPortal@gmail.com). We encourage the paleobotany community to register for an account and to use the PBot workbench and private groups to conduct new research. Remember to make your data public once you publish! As part of your research, we hope that you will populate PBot with historic data- dig into those old monographs, find and photograph original type specimens, enter published diagnoses, and create new descriptions in which you score characters.

We are excited to announce that the PBot team has joined forces with the [Paleobiology Database](https://paleobiodb.org/#/) and received a [new NSF grant](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2514539&HistoricalAwards=false) to undertake a complete technological overhaul of the PBDB and integrate PBot's cutting-edge conceptual framework and innovative user-centric capabilities. As part of this award, we will be able to make substantive upgrades to PBot and create new functionality. As we have done in the past, we will solicit community feedback to guide us.
