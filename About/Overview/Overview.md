...
## The Future of PBot
PBot version 1.0 is now completed, as our NSF EarthCube Award ended in August, 2025. We will continue to maintain PBot and fix bugs- please report any bugs by [emailing us](mailto:PBotPortal@gmail.com). We encourage the paleobotany community to register for an account and to use the PBot workbench and private groups to conduct new research. Remember to make your data public once you publish! As part of your research, we hope that you will populate PBot with legacy data- dig into those old monographs, find Knowlton's type specimens, enter original diagnoses, and create new descriptions in which you score characters.
